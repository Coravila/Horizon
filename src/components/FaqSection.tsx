...
const FaqSection: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Absolutamente! Oferecemos suporte completo via chat, email e material educativo. Nossa equipe está disponível para auxiliar com dúvidas técnicas, estratégias de venda e otimizações. Além disso, você tem acesso a uma comunidade de empreendedores usando nossas lojas."
    }
  ];
